...
async function* fetchReason(url: string, body: Record<string, any> = {}, headers: Record<string, any> = {}) {
...
export default function useChat<T = ReasonChatMessage>(entrypointUrl: string, config: Partial<ChatConfig> = {}) {
  ...
  async function send(input: string) {
    try {
      ...
      let gen = fetchReason(entrypointUrl, {...config.body, input, memory_id: memoryID || undefined}, config.headers)
